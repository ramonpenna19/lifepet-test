      ...
      <div class="row">
        <div class="col-md-5 intro-caption">
          <h1 class="intro-title">
            Expert health advice <br> for <span>wealth life</span>
          </h1>
      ...
      <div class="row">
        ...
        <div class="col-md-offset-1 col-md-4">
          <div class="appoinment-form">
            ...
            <form id="formFormulario" role="form" action="{{ route('formulario.store') }}" method="post">
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
              <div class="form-group">
                <label for="app_name">Name</label>
                <input type="text" class="form-control" id="app_name" name="nome" placeholder="Name" required>
              </div>
              <div class="form-group">
                <label for="app_email">E-mail</label>
                <input type="email" class="form-control" id="app_email" name="email" placeholder="E-mail" required>
              </div>
              <div class="form-group">
                <label for="app_phone">Phone</label>
                <input type="text" class="form-control" id="app_phone" name="telefone" placeholder="Phone" required="">
              </div>
              <button form="formFormulario" type="submit" class="btn btn-block btn-orange btn-Submit">SUBMIT</button>
